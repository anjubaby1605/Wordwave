...
//     }
//   }, [isLoggedIn]);
//   // Add this inside your component (e.g., HomePage.js)
...
//       }
//     });
//     setStories(res.data); // Assuming you already have setStories state
//   } catch (err) {
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    fetchStories();
  }, [isLoggedIn]); // Dependency on login status to fetch relevant stories
  ...
  <div className="dropdown-menu">
    {!isLoggedIn ? (
      ...
      <>
        {/* Change this from "/stories" to "/mystories" */}
